            ...
            <Card className="lg:col-span-4 border-border/50">
              ...
              <CardContent className="pl-2">
                <div className="h-[300px] w-full" style={{ minHeight: 300, minWidth: 0 }}>
                  {isMounted && evolucaoData.length > 0 ? (
                    ...
                    <div className="h-full flex items-center justify-center text-muted-foreground text-sm">
                      {evolucaoData.length === 0 ? "Sem dados para exibir" : "Carregando grafico..."}
                    </div>
                  )}
                </div>
              </CardContent>
            ...
            <div className="lg:col-span-3 space-y-6">
              <Card className="border-border/50 h-full flex flex-col">
                ...
                <CardContent className="flex-1">
                  <div className="h-[300px] w-full" style={{ minHeight: 300, minWidth: 0 }}>
                    {isMounted && motivosData.length > 0 ? (
                      <ResponsiveContainer width="100%" height="100%">
                      ...
                      <div className="h-full flex items-center justify-center text-muted-foreground text-sm">
                        {motivosData.length === 0 ? "Sem dados suficientes" : "Carregando grafico..."}
                      </div>
                    )}
                  </div>
                </CardContent>
