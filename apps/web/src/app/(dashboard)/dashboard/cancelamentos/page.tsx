...
export default function CancellationsPage() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Cancelamento aprovado. Strike aplicado ao médico.");
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-rose-600">
              ...
              Confirmar Aprovação e Strike
            </DialogTitle>
            <DialogDescription>
              Você está prestes a aprovar o cancelamento desta agenda.
            </DialogDescription>
          </DialogHeader>
          ...
          <Alert variant="destructive" className="bg-rose-50 border-rose-200 text-rose-800 dark:bg-rose-900/20 dark:border-rose-900">
            ...
            <AlertDescription>
              Ao aprovar, um <strong>Strike</strong> será automaticamente adicionado ao perfil do médico. Se o médico atingir 3 strikes, ele poderá ser suspenso.
            </AlertDescription>
          </Alert>
      ...
      <Dialog open={isRejectOpen} onOpenChange={setIsRejectOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            >
              {rejectMutation.isPending ? "Enviando..." : "Rejeitar Solicitação"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
