...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-brand-500 text-white shadow-xs ring-1 ring-transparent ring-inset hover:bg-brand-600 data-loading:bg-brand-600",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Disabled styles
                "disabled:bg-gray-200 disabled:shadow-xs disabled:ring-gray-200 disabled:text-gray-400",
                // Icon styles
        ...
        secondary: {
            root: [
                "bg-white text-gray-700 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 hover:text-gray-900 data-loading:bg-gray-50",
                // Disabled styles
                "disabled:shadow-xs disabled:ring-gray-200 disabled:bg-gray-50",
                // Icon styles
                "*:data-icon:text-gray-500 hover:*:data-icon:text-gray-700",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-gray-600 hover:bg-gray-100 hover:text-gray-900 data-loading:bg-gray-100",
                // Icon styles
                "*:data-icon:text-gray-500 hover:*:data-icon:text-gray-700",
            ].join(" "),
        },
        ...
        "secondary-destructive": {
            root: [
                "bg-white text-red-600 shadow-xs ring-1 ring-red-200 outline-red-500 ring-inset hover:bg-red-50 hover:text-red-700 data-loading:bg-red-50",
                // Disabled styles
                "disabled:bg-gray-50 disabled:shadow-xs disabled:ring-gray-200",
                // Icon styles
                "*:data-icon:text-red-500 hover:*:data-icon:text-red-600",
            ].join(" "),
        },
